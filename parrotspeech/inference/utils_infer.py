...
from parrotspeech.model.utils import (
    get_tokenizer,
...
def infer_process(
    ...
    max_chars = int(len(ref_text.encode("utf-8")) /
                    (audio.shape[-1] / sr) * (22 - audio.shape[-1] / sr))
...
def infer_batch_process(
    ...
    def process_batch(gen_text):
        ...
        if fix_duration is not None:
            ...
            duration = ref_audio_len + \
                int(ref_audio_len / ref_text_len * gen_text_len / local_speed)
    ...
    if streaming:
        ...
        with ThreadPoolExecutor() as executor:
            futures = [executor.submit(process_batch, gen_text)
            ...
            if cross_fade_duration <= 0:
                ...
                for i in range(1, len(generated_waves)):
                    ...
                    cross_fade_samples = int(
                        cross_fade_duration * target_sample_rate)
